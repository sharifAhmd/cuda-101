...
#define N 512               // Number of atoms
#define MAX_NEIGHBORS 64    // Max neighbors per atom
#define CUTOFF 0.2f         // Cutoff distance

struct Atom {
    float x, y, z;
};

// CUDA kernel to compute neighbor list
